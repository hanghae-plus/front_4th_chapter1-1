...
const LoginPage = () => {
  ...
  <main class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
      ...
      <form id="login-form">
        <div class="mb-4">
          <input id="username" name="username" type="text" placeholder="유저 네임" class="w-full p-2 border rounded">
        </div>
        <div class="mb-6">
      ...
      <div class="text-center">
        <button lass="bg-green-500 text-white px-4 py-2 rounded font-bold">새 계정 만들기</button>
      </div>
    </div>
  </main>
`;
