...
React에 익숙해져 있던 저에게 바닐라 자바스크립트로 구현하는 과제는 큰 어려움이었습니다.
이 과제를 통해 자바스크립트의 기본기를 다시 한번 되짚어보고 부족한 부분을 깨달았습니다.
특히, 기능 구현에만 집중한 나머지 원리에 대한 이해가 부족했던 점이 가장 큰 문제였습니다.
이번 경험을 통해 개발의 근본을 놓치지 않고, 깊이 있는 학습의 중요성을 깨달았습니다.
앞으로는 원리와 개념을 충분히 이해하며 학습하고자 합니다..
